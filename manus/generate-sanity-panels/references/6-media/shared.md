...
1. Define **visualSystem** (palette, photography) from `designConcept` + domain rules
...
5. Upload **generated/custom** assets to Sanity; record `sanityAssetRef` in `mediaPlan`
...
```json
{
  "visualSystem": { "palette": {}, "photography": "", "styleRef": "..." },
  "imageBrief": [ ... ],
  "mediaPlan": [
    {
      "blockId": "...",
